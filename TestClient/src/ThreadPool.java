...
/**
 * 
 * （这个线程池是根据Tomcat中的源码修改的，并去掉了一些功能，不再支持ThreadWithAtributes
 * ,ThreadPoolRunnable,只是单单支持Runnable。这样看起来还算是比较简单。）
 * 
 * @author Gal Shachor
...
public class ThreadPool {
	...
	public String toString() {
		return "busy=" + currentThreadsBusy + " currentCount="
				+ currentThreadCount;
	}
